...
for token in tokens:
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            if servers_response.status_code == 200 and friends_response.status_code == 200:
            ...
            valid_tokens.append((token, user_id, username, discriminator, banner_url, avatar_url, locale, nsfw_allowed, mfa_enabled, creation_date, premium_type, verified, phone, email, servers_count, friends_count))
